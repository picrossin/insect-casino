...
{
    const string privateCode = "N5EBQ2Z2oEi_9Ywh7O1ctg74XBbqSMlk-6SMBsMJVRkQ";  //Key to Upload New Info
    const string publicCode = "62d2f7098f40bb84ec72d43e";   //Key to download
